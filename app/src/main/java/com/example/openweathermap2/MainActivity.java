       ...
       /* p10 = findViewById(R.id.p10);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MainActivity.this, Day2Activity.class);
    ...
    private class GetUrlData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                p1.setText("temp: "+obj.getJSONArray("list").getJSONObject(0).getJSONObject("main").getString("temp")+" K");
                date1.setText(obj.getJSONArray("list").getJSONObject(0).getString("dt_txt").substring(5,16));

               /* p1.setText("temp: "+obj.getJSONArray("list").getJSONObject(1).getJSONObject("main").getString("temp"));
                date1.setText(obj.getJSONArray("list").getJSONObject(1).getString("dt_txt"));

                p2.setText("temp: "+obj.getJSONArray("list").getJSONObject(2).getJSONObject("main").getString("temp"));
                date2.setText(obj.getJSONArray("list").getJSONObject(2).getString("dt_txt"));

                p3.setText("temp: "+obj.getJSONArray("list").getJSONObject(3).getJSONObject("main").getString("temp"));
                date3.setText(obj.getJSONArray("list").getJSONObject(3).getString("dt_txt"));

                p4.setText("temp: "+obj.getJSONArray("list").getJSONObject(4).getJSONObject("main").getString("temp"));
                date4.setText(obj.getJSONArray("list").getJSONObject(4).getString("dt_txt"));

                */p5.setText("temp: "+obj.getJSONArray("list").getJSONObject(5).getJSONObject("main").getString("temp")+" K");
                date5.setText(obj.getJSONArray("list").getJSONObject(5).getString("dt_txt").substring(5,16));

                /*p6.setText("temp: "+obj.getJSONArray("list").getJSONObject(6).getJSONObject("main").getString("temp"));
                date6.setText(obj.getJSONArray("list").getJSONObject(6).getString("dt_txt"));

                p7.setText("temp: "+obj.getJSONArray("list").getJSONObject(7).getJSONObject("main").getString("temp"));
                date7.setText(obj.getJSONArray("list").getJSONObject(7).getString("dt_txt"));

                p8.setText("temp: "+obj.getJSONArray("list").getJSONObject(8).getJSONObject("main").getString("temp"));
                date8.setText(obj.getJSONArray("list").getJSONObject(8).getString("dt_txt"));
*/
                p9.setText("temp: "+obj.getJSONArray("list").getJSONObject(9).getJSONObject("main").getString("temp")+" K");
                date9.setText(obj.getJSONArray("list").getJSONObject(9).getString("dt_txt").substring(5,16));

                /*p10.setText("temp: "+obj.getJSONArray("list").getJSONObject(10).getJSONObject("main").getString("temp"));
                date10.setText(obj.getJSONArray("list").getJSONObject(10).getString("dt_txt"));

                p11.setText("temp: "+obj.getJSONArray("list").getJSONObject(11).getJSONObject("main").getString("temp"));
                date11.setText(obj.getJSONArray("list").getJSONObject(11).getString("dt_txt"));

                p12.setText("temp: "+obj.getJSONArray("list").getJSONObject(12).getJSONObject("main").getString("temp"));
                date12.setText(obj.getJSONArray("list").getJSONObject(12).getString("dt_txt"));
*/
                p13.setText("temp: "+obj.getJSONArray("list").getJSONObject(13).getJSONObject("main").getString("temp")+" K");
                date13.setText(obj.getJSONArray("list").getJSONObject(13).getString("dt_txt").substring(5,16));

                /*p14.setText("temp: "+obj.getJSONArray("list").getJSONObject(14).getJSONObject("main").getString("temp"));
                date14.setText(obj.getJSONArray("list").getJSONObject(14).getString("dt_txt"));

                p15.setText("temp: "+obj.getJSONArray("list").getJSONObject(15).getJSONObject("main").getString("temp"));
                date15.setText(obj.getJSONArray("list").getJSONObject(15).getString("dt_txt"));

                p16.setText("temp: "+obj.getJSONArray("list").getJSONObject(16).getJSONObject("main").getString("temp"));
                date16.setText(obj.getJSONArray("list").getJSONObject(16).getString("dt_txt"));
*/
                p17.setText("temp: "+obj.getJSONArray("list").getJSONObject(17).getJSONObject("main").getString("temp")+" K");
                date17.setText(obj.getJSONArray("list").getJSONObject(17).getString("dt_txt").substring(5,16));

               /* p18.setText("temp: "+obj.getJSONArray("list").getJSONObject(18).getJSONObject("main").getString("temp"));
                date18.setText(obj.getJSONArray("list").getJSONObject(18).getString("dt_txt"));

                p19.setText("temp: "+obj.getJSONArray("list").getJSONObject(19).getJSONObject("main").getString("temp"));
                date19.setText(obj.getJSONArray("list").getJSONObject(19).getString("dt_txt"));

                p20.setText("temp: "+obj.getJSONArray("list").getJSONObject(20).getJSONObject("main").getString("temp"));
                date20.setText(obj.getJSONArray("list").getJSONObject(20).getString("dt_txt"));
*/
                p21.setText("temp: "+obj.getJSONArray("list").getJSONObject(21).getJSONObject("main").getString("temp")+" K");
                date21.setText(obj.getJSONArray("list").getJSONObject(21).getString("dt_txt").substring(5,16));

                /*p22.setText("temp: "+obj.getJSONArray("list").getJSONObject(22).getJSONObject("main").getString("temp"));
                date22.setText(obj.getJSONArray("list").getJSONObject(22).getString("dt_txt"));

                p23.setText("temp: "+obj.getJSONArray("list").getJSONObject(23).getJSONObject("main").getString("temp"));
                date23.setText(obj.getJSONArray("list").getJSONObject(23).getString("dt_txt"));
*/
               /* p24.setText("temp: "+obj.getJSONArray("list").getJSONObject(24).getJSONObject("main").getString("temp"));
                date24.setText(obj.getJSONArray("list").getJSONObject(24).getString("dt_txt"));
*/
